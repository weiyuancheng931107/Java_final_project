package com.musicapp.innerjudge.MusicStyle;

import java.io.IOException;
import java.util.*;
import javax.sound.midi.InvalidMidiDataException;
import javax.sound.midi.MidiUnavailableException;
import com.musicapp.innerjudge.MusicGenerator.*;
/**
 * Interface defining the methods required for a Reggae rhythm section.
 */
...
/**
 * Class representing the Reggae music genre, implementing the InnerReggae interface.
 */
public class Reggae implements InnerReggae {
    ...
    /**
     * Constructor for the Reggae class.
    ...
    public Reggae(int bpm, int velocity, Map<Integer, ArrayList<Integer>> chordHashMap, int barAmount) throws InvalidMidiDataException, MidiUnavailableException {
        ...
        System.out.println("baramount"+barAmount);
    }



    /**
     * Method to generate the drum track for the Reggae rhythm.
     * @throws InvalidMidiDataException
     * @throws MidiUnavailableException
     * @throws IOException
     */
    ...
    public void drums() throws InvalidMidiDataException, MidiUnavailableException, IOException {
        ...
        for (int j = 0; j < (barAmount - 1) / 16; j++) {
            Collections.addAll(drumsBeat, 2.0, 2.0, 1.0, 2.0, 2.0, 1.0, 2.0, 2.0, 1.0, 2.0, 2.0, 1.0, 2.0, 2.0, 1.0, 2.0, 2.0, 1.0, 2.0, 2.0, 1.0, 2.0, 2.0, 1.0);

            // Populate drum chords for each beat
            drumChord = new ArrayList<>(Arrays.asList(Drumsound.CLOSED_HI_HAT));
            drumChordFinal.add(drumChord);
            drumChord = new ArrayList<>(Arrays.asList(Drumsound.CLOSED_HI_HAT));
            drumChordFinal.add(drumChord);
            drumChord = new ArrayList<>(Arrays.asList(Drumsound.CLOSED_HI_HAT));
            drumChordFinal.add(drumChord);
            drumChord = new ArrayList<>(Arrays.asList(Drumsound.CLOSED_HI_HAT, Drumsound.SIDE_STICK,Drumsound.ACOUSTIC_BASS_DRUM));
            drumChordFinal.add(drumChord);
            drumChord = new ArrayList<>(Arrays.asList(Drumsound.CLOSED_HI_HAT));
            drumChordFinal.add(drumChord);
            drumChord = new ArrayList<>(Arrays.asList(Drumsound.CLOSED_HI_HAT));
    ...
    /**
     * Method to generate the guitar track for the Reggae rhythm.
     * @throws InvalidMidiDataException
     * @throws MidiUnavailableException
     * @throws IOException
     */
    ...
    public void guitar() throws InvalidMidiDataException, MidiUnavailableException, IOException {
        ...
        Metronome guitar = new Metronome(bpm, 27, guitarChordFinal, 4, velocity, guitarBeatFinal, 0);
        guitar.rhythmChord();
        guitar.writeToFile("guitar");
    }

    /**
     * Method to generate the bass track for the Reggae rhythm.
     * @throws InvalidMidiDataException
     * @throws MidiUnavailableException
     * @throws IOException
     */
    ...
    /**
     * Method to generate the piano track for the Reggae rhythm.
     * @throws InvalidMidiDataException
     * @throws MidiUnavailableException
     * @throws IOException
     */
